...
<template>
  <div style="display: flex;">
    <div style="flex: 1;">
      <h3>HTML</h3>
      <div ref="htmlEditor" style="height: 200px;" id="htmlEditor"></div>
      <h3>CSS</h3>
      <div ref="cssEditor" style="height: 200px;" id="cssEditor"></div>
      <h3>JavaScript</h3>
      <div ref="jsEditor" style="height: 200px;" id="jsEditor"></div>
    </div>
    <div style="flex: 1;">
      <h3>预览</h3>
